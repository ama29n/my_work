...
public:
    Googlepay(string type1, string type2) : Payment(createPaymentStrategyFactory()->getPaymentStrategyType(type1), createAppFactory()->getApplicationStrategyType(type2)) {
